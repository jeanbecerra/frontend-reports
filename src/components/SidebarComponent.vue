...
<template>
  <div :class="[
    ...
    isOpen ? 'w-56 bg-white shadow-lg' : 'w-[3.35rem] bg-gray-100'
  ]">
    ...
    <div class="flex h-screen flex-col justify-between pt-2 pb-6">
      ...
      <div>
        <!-- Logo -->
        <div class="w-max ml-10 mt-5">
          <img v-if="isOpen" src="@/assets/logoFravatel.png" class="w-32" alt="">
        </div>

        <!-- Menú -->
        <ul class="mt-20 space-y-4 tracking-wide">

          <!-- Dashboard -->
          <li>
            <router-link
              to="/dashboard"
              class="flex items-center space-x-4 px-4 mt-4 py-3 rounded-md transition-colors duration-200"
